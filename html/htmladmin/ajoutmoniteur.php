...
$sql0="select * from moniteur where cin3 = '$cin'";
$result0=mysqli_query($con,$sql0);

if (mysqli_num_rows($result0)!=0){
    echo '<script type="text/javascript"> ';
    echo 'alert("Moniteur Existant !") ; ';
    echo' </script>';
}

else {
$sql="insert into moniteur (email3,mdp3,cin3,nom,prenom,dtn,adresse,salaire) values ('$email','$mdp','$cin','$nom','$prenom', '$date' ,'$adresse', '$salaire') ";
