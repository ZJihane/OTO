...
$sql0="select * from vehicule where matricule = '$matricule' ";
$result0=mysqli_query($con,$sql0);

if (mysqli_num_rows($result0)!=0){
    echo '<script type="text/javascript"> ';
    echo 'alert("vehicule Existante !") ; ';
    echo' </script>';
}

else {
$sql="insert into vehicule (matricule,puissance,energie,marque) values('$matricule','$puissance','$energie','$marque')";
...
<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar">
    ...
    <fieldset>
        <form method="POST" > 
           ...
           <label>Puissance réele en chevaux:</label>
           <input type="text" name="puis" required /><br>
           ...
           <label> Marque :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
           <input type="name" name="marque" required /><br>
