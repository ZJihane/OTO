...
$typee=$_GET['updatetype'];
$sql1="select * from permis where type = '$typee' " ;
...
$sql2 = "update permis set tarif='$tarif' where type='$typee'";
$result2=mysqli_query($con,$sql2);

if($result2){
    echo '<script type="text/javascript"> ';
    echo 'alert("modification reussie") ; ';
    echo 'window.location.href = "gesttarif.php? cin='.$cin_admin.'" ;' ;
    echo' </script>';
}
else{
    echo '<script type="text/javascript"> ';
...
<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar">
    ...
    <fieldset>
        <form method="POST" > 
           ...
           <label>tarif</label>
           <input type="number" name="tarif" required value=<?php echo $tarif ;?>><br>
