...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../../css/csscandidat/rd.css">
  <meta charset="utf-8">
...
<br> <br>
<h1><b>Rendez-vous pour cours pratique</b></h1>
 <table class="table table-light">
    ...
    <tbody>
      ...
      $sql = $sql1="select * from rdv_pratique where cin2= '$cin_candidat' " ;
   ...
   <h1><b>Rendez-vous pour cour theorique</b></h1>
   <table class="table table-light">
    <thead>
      <tr>
        <th scope="col">Cin moniteur</th>
    ...
    <tbody>
      ...
      $sql = $sql1="select * from rdv_theo where id_candidat= '$cin_candidat' " ;
      $result = mysqli_query($con, $sql);
