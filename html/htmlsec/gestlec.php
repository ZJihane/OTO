...
<nav  class="navbar navbar-expand-lg navbar-light " style="background-color: #8a888285;" >
  ...
  <button class="btn btn-primary"> <a <?php echo'href= "ajoutlec.php ? cin='.$cin_sec.'  & cin='. $cin_sec .'"'?>class="text-light" > ajouter leçon <i class="fa fa-plus"  ></i></a></button>
  <table class="table table-light">
    <thead>
      <tr>
      <th scope="col">ID leçon</th>
     ...
     <tbody>
      ...
      $result = mysqli_query($con, $sql);
        ...
        <td>'. $nom.'</td>
        <td>'. $tp.'</td>
        <td> <button class="btn btn-danger"><a href="supplec.php? deletelec=' . $id_lec. '& cin='. $cin_sec .'" class="text-light" > supprimer <i class="fa fa-trash"  ></i> </a></button> </td> 
      </tr>';
