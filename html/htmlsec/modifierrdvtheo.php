...
$id=$_GET['updaterdv'];
$sql1="select * from rdv_theo where id_rdv = '$id' " ;
...
$sql4="select id_moniteur from rdv_theo where num_seance != '$nums' and  id_moniteur='$idm' and date='$date' and heure='$heure' ";
$result4=mysqli_query($con,$sql4);

$sql6="select salle from rdv_theo where salle='$salle' and date='$date' and heure='$heure' and num_seance!='$nums' ";
$result6=mysqli_query($con,$sql6);

$sql5="select * from salle where capacité >= (select distinct(nb_part) from rdv_theo where num_seance = '$nums') and num_salle = '$salle' ";
...
elseif (mysqli_num_rows($result5)==0){
    echo '<script type="text/javascript"> ';
    echo 'alert("capacité de salle insuffisante!") ; ';
    echo' </script>';
}
    ...
    $sql = "update rdv_theo set id_moniteur = '$idm' , salle ='$salle'  , date='$date' ,heure='$heure'  ";
...
<nav  class="navbar navbar-expand-lg navbar-light " style="background-color: #8a888285;" >
    ...
    <form method="POST" > 
          <label>CIN moniteur :&nbsp;&nbsp;&nbsp;</label>
           ...
           <label>Salle:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
           <input type="name" name="salle"  value=<?php echo $salle ?>><br>
